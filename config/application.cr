...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Amber Learning web application."
  #
  #
  ...
  #
  # settings.secret_key_base= HsnR_Jp_WVUFTMS2v-ou_FPpGrbrZOkf0DSrx8T6NTk
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("amber-learning.log", "w"))
  #
  #
end
